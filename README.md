...
*Challenges designed, developed, and deployed for competitive cybersecurity events.*

#### 🤖 [MSP AI CTF 2026](https://github.com/MushroomWasp/msp-ai-ctf-2026)
> Architected custom Capture The Flag challenges focusing on AI vulnerabilities and security concepts.

#### 🗄️ [DB Security CTF](https://github.com/ziaddevv/db-security-ctf)
> Developed database security-focused Capture The Flag scenarios designed to test offensive capabilities.
